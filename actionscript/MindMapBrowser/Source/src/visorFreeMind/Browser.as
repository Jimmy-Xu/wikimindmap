 ...
 *Copyright (C) 2000-2005  Joerg Mueller, Daniel Polansky, Christian Foltin, Juan Pedro, Felix Nyffenegger and others.
 *
...
class visorFreeMind.Browser {
	...
	public static var defaultToolTipWordWrap=500;
	...
	function showTooltip(texto,dx,dy){
		...
		my_fmt.color=0x002222;
		my_fmt.font="Arial";
		tt.tex_container.textfield.setTextFormat(my_fmt);
		tt.tex_container.textfield.text = texto;
