...
/*
* Original Author of Freemind: Juan Pedro de Andres
* Reauthor for WikiMindMap: Felix Nyffenegger
* 
* This class is configured to be the called with MSTAC (Motion-Twin ActionScript 2 Compiler)
* 
* Comments of reauthoring:
* This code uses Freemind as template/basis, but parts of it are rewritten or changed,
* because this application follows other goals then FreeMind
* This MindMap only needs one representation style, no editing capablilites and no history.
* Crutial reqirements are 
* 	- performance and 
* 	- most easiest usability. 
* The code should also be reuasable for different scenarios of application e.g.
* 	- WikiMindMap: Topic Browser
* 	- Or Whatever you linke
* 
*/
